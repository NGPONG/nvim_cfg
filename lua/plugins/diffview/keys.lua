...
------------------------------------------------------------------------------------------------
function M.set_filepanel_keymaps(...)
  return {
    { binder.E_NORMAL, 'tc', '<NOP>', key_opts('Disable tc') },
    { binder.E_NORMAL, 'a', '<NOP>', key_opts('Disable a') },
    { binder.E_NORMAL, 'v', '<NOP>', key_opts('Disable v') },
    { binder.E_NORMAL, 'sc', '<NOP>', key_opts('Disable sc') },

    { binder.E_NORMAL, '<cr>', actions.select_entry, key_opts('Open the diff for the selected entry') },
    { binder.E_NORMAL, 'ga', function ()
    ...
    { binder.E_NORMAL, 'gc', helper.git_commit , key_opts('Commit the git message.') },
    { binder.E_NORMAL, 'gp', helper.git_push, key_opts('Push commits into remote.') },
  }
end
------------------------------------------------------------------------------------------------
...
--  binder.keymap(binder.E_NORMAL, '<C-d>', '<NOP>', key_opts('Disable gd'))
--end)
--
--events.rg_on_nvim_enter(function ()
--  binder.keymap(binder.E_NORMAL, '<C-d>', function ()
--    require('diffview').close()
--  end, key_opts('Open Diffview', { remap = false }))
--end)
------------------------------------------------------------------------------------------------
